...
public class GameServiceTest {
  ...
  public void init()
    ...
    this.gameFinishedWinnerSouth.getBoard().getPit(Player.PLAYER_A.getHouseIndex())
        .setStoneCount(10);
    this.gameFinishedWinnerSouth.getBoard().getPit(Player.PLAYER_B.getHouseIndex())
        .setStoneCount(62);
    ...
    this.gameFinishedWinnerNorth.getBoard().getPit(Player.PLAYER_A.getHouseIndex())
        .setStoneCount(39);
    this.gameFinishedWinnerNorth.getBoard().getPit(Player.PLAYER_B.getHouseIndex())
        .setStoneCount(32);
  ...
  public void testPlay() {
    ...
    Assert.assertEquals(31, game.getBoard().getStoneCount(Player.PLAYER_A, true));
  }

  @Test
  public void testDecidePlayerTurn() {
    Assert.assertNull(this.gameInitial.getTurn());
    Assert.assertEquals(Player.PLAYER_A, this.gameNorthMovedFirst.getTurn());
    Assert.assertEquals(Player.PLAYER_A, this.gameSouthMovedFirst.getTurn());
  }
  ...
  public void testDetermineWinner()
    ...
    Assert.assertEquals(Player.PLAYER_B, this.gameFinishedWinnerSouth.getWinner());
    Assert.assertEquals(Player.PLAYER_A, this.gameFinishedWinnerNorth.getWinner());
  }
  ...
  public void testCheckGameOver()
    ...
    Assert.assertEquals(10,
        this.gameFinishedWinnerSouth.getBoard().getStoneCount(Player.PLAYER_A, true));
    Assert.assertEquals(62,

        this.gameFinishedWinnerSouth.getBoard().getStoneCount(Player.PLAYER_B, true));
    Assert.assertEquals(40,
        this.gameFinishedWinnerNorth.getBoard().getStoneCount(Player.PLAYER_A, true));
    Assert.assertEquals(32,
        this.gameFinishedWinnerNorth.getBoard().getStoneCount(Player.PLAYER_B, true));
  }
  ...
  public void testLastEmptyPit()
    ...
    this.gameTurnNorth.getBoard().getPit(Player.PLAYER_A.getHouseIndex()).setStoneCount(0);
    this.gameTurnNorth.getBoard().getPit(Player.PLAYER_B.getHouseIndex()).setStoneCount(0);
    ...
    Assert.assertEquals(7, this.gameTurnNorth.getBoard().getStoneCount(Player.PLAYER_A, true));
    Assert.assertEquals(0, this.gameTurnNorth.getBoard().getStoneCount(Player.PLAYER_B, true));
  }
