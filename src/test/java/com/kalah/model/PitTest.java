...
public class PitTest {
  ...
  public void testOwner() {
    ...
    Assert.assertEquals(Player.PLAYER_A, givenPit1.getOwner());
    Assert.assertEquals(Player.PLAYER_A, givenPit2.getOwner());
    Assert.assertEquals(Player.PLAYER_B, givenPit3.getOwner());
    Assert.assertEquals(Player.PLAYER_B, givenPit4.getOwner());
  }
