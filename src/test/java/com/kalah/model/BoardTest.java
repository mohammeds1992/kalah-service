...
public class BoardTest {
  ...
  public void testStoneCount() {
    ...
    Assert.assertEquals(36, givenBoard1.getStoneCount(Player.PLAYER_A, true));
    Assert.assertEquals(30, givenBoard2.getStoneCount(Player.PLAYER_A, true));
    Assert.assertEquals(39, givenBoard2.getStoneCount(Player.PLAYER_B, true));
  }
}
